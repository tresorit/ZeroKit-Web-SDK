// Type definitions for zerokit-web-sdk 4.0
// Project: https://github.com/tresorit/ZeroKit-Web-SDK
// Definitions by: Mihaly Lengyel <https://github.com/porcellus>
 ...
 */
declare class InputIframe extends IframeHandler {
	/**
 ...
 */
declare type LoginCallback = (userId: string, willRedirect: boolean) => (Thenable | any);

declare class LoginIframe extends InputIframe {
	/**
...
declare class RegisterIframe extends InputIframe {
	/**
 ...
 */
declare class AcceptInvitationLinkIframe extends InputIframe {
	/**
...
interface CreateInvitationLinkIframe extends InputIframe {
	/**
...
interface ChangePasswordIframe extends InputIframe {
	/**
 ...
 */
interface InvitationLinkPublicInfo {
	/**
